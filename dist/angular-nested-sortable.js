                        ...
                        var dragStartEvent = function(e) {
                            ...
                            var nodrag = function (targetElm) {
                                return (typeof targetElm.attr('nodrag')) != "undefined"
                                    ...
                                    || (typeof sourceItem.nodrag) != "undefined";
                            };
                            ...
                            var delayDragging = function(e) {
                                var movement = Math.abs(e.pageX - startX) + Math.abs(e.pageY - startY);

                                if (movement >= 10) {
                                    initDragging();
                                    angular.element($document).unbind('mouseup', unbindDelayDragging);
                                    unbindDelayDragging();
                                }
                            };

                            var unbindDelayDragging = function() {
                                angular.element($document).unbind('mousemove', delayDragging);
                            };

                            angular.element($document).bind('mousemove', delayDragging);
                            angular.element($document).bind('mouseup', unbindDelayDragging);
